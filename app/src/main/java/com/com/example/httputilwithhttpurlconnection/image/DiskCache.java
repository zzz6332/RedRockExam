...
public class DiskCache implements ImageCache {
    ...
    public Bitmap get(String url,int reqWdith,int reqHeight) {
        ...
        return com.com.example.httputilwithhttpurlconnection.image.MyBitmapFactory.decodeFile(context.getCacheDir() + "/" + url.substring(url.lastIndexOf("/")),reqWdith,reqHeight);
    }
