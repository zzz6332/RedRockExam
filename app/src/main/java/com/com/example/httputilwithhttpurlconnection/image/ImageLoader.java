package com.com.example.httputilwithhttpurlconnection.image;
...
public class ImageLoader {
    ...
    private com.com.example.httputilwithhttpurlconnection.image.ImageCache cache;
    ...
    public ImageLoader(com.com.example.httputilwithhttpurlconnection.image.ImageCache imageCache, int loadId, int failId) { //初始化图片加载的策略
        cache = imageCache;
        this.loadId = loadId;
        this.failId = failId;
    ...
    public void display(ImageView imageView, Resources resources,int id,int reqWidth,int reqHeight){
        ...
        imageView.setImageBitmap(com.com.example.httputilwithhttpurlconnection.image.MyBitmapFactory.decodeRes(resources,id,reqWidth,reqHeight));
    }
    ...
    private Bitmap downloadBitmap(final String imageUrl,int reqWidth,int reqHeight) {
        ...
        try {
           ...
           bitmap = com.com.example.httputilwithhttpurlconnection.image.MyBitmapFactory.decodeStream(url,reqWidth,reqHeight);
